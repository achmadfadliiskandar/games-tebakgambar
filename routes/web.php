...
Route::get('/pemain/answer/jawab/{id}/{created_at}/{updated_at}/{random_int}/{strandom}',[App\Http\Controllers\HomeController::class, 'tebakjawaban'])->middleware('checkRole:pemain');
Route::get('/pemain/jawab/jawaban/{id}/{created_at}/{updated_at}/{random_int}/{strandom}',[App\Http\Controllers\HomeController::class, 'tebakanjawaban'])->middleware('checkRole:pemain');
